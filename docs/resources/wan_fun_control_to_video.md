...
page_title: "comfyui_wan_fun_control_to_video Resource - comfyui"
subcategory: ""
description: |-
  ComfyUI WanFunControlToVideo node [conditioning/video_models] Source: comfy_extras/nodes_wan.py:64 (v3_extras).
---

# comfyui_wan_fun_control_to_video (Resource)
