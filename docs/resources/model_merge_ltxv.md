...
subcategory: ""
description: |-
  ComfyUI ModelMergeLTXV node — ModelMergeLTXV [advanced/model_merging/model_specific]
---
...
- `adaln_single` (String) Input: COMBO
- `caption_projection` (String) Input: COMBO
- `model1` (String) Input: MODEL (link)
- `model2` (String) Input: MODEL (link)
- `patchify_proj` (String) Input: COMBO
- `proj_out` (String) Input: COMBO
- `scale_shift_table` (String) Input: COMBO
