...
page_title: "comfyui_wan_camera_image_to_video Resource - comfyui"
subcategory: ""
description: |-
  ComfyUI WanCameraImageToVideo node [conditioning/video_models] Source: comfy_extras/nodes_wan.py:396 (v3_extras).
---

# comfyui_wan_camera_image_to_video (Resource)
...
- `camera_conditions` (String) Input: WAN_CAMERA_EMBEDDING. Link input.
