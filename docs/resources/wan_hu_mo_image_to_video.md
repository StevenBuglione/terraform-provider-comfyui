...
page_title: "comfyui_wan_hu_mo_image_to_video Resource - comfyui"
subcategory: ""
description: |-
  (EXPERIMENTAL) ComfyUI WanHuMoImageToVideo node [conditioning/video_models] Source: comfy_extras/nodes_wan.py:1044 (v3_extras).
---

# comfyui_wan_hu_mo_image_to_video (Resource)
...
- `length` (Number) Input: INT. Default: 97. Minimum value: 1. Step: 4.
