...
subcategory: ""
description: |-
  1.3B model has 30 blocks, 14B model has 40 blocks. Image to video model has the extra img_emb. [advanced/model_merging/model_specific]
---
...
- `head` (String) Input: COMBO
- `img_emb` (String) Input: COMBO
- `model1` (String) Input: MODEL (link)
- `model2` (String) Input: MODEL (link)
- `patch_embedding` (String) Input: COMBO
- `text_embedding` (String) Input: COMBO
- `time_embedding` (String) Input: COMBO
- `time_projection` (String) Input: COMBO
