...
- `end_percent` (Number) Input: FLOAT. Default: 0.95. Allowed range: 0.0 to 1.0. Step: 0.01. Tooltip: The relative sampling step to end use of LazyCache.
...
- `start_percent` (Number) Input: FLOAT. Default: 0.15. Allowed range: 0.0 to 1.0. Step: 0.01. Tooltip: The relative sampling step to begin use of LazyCache.
