...
page_title: "comfyui_hunyuan_video15_image_to_video Resource - comfyui"
subcategory: ""
description: |-
  ComfyUI HunyuanVideo15ImageToVideo node [conditioning/video_models] Source: comfy_extras/nodes_hunyuan.py:79 (v3_extras).
---

# comfyui_hunyuan_video15_image_to_video (Resource)
...
- `length` (Number) Input: INT. Default: 33. Minimum value: 1. Step: 4.
