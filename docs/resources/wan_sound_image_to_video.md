...
page_title: "comfyui_wan_sound_image_to_video Resource - comfyui"
subcategory: ""
description: |-
  ComfyUI WanSoundImageToVideo node [conditioning/video_models] Source: comfy_extras/nodes_wan.py:949 (v3_extras).
---

# comfyui_wan_sound_image_to_video (Resource)
...
- `ref_motion` (String) Input: IMAGE. Link input.
