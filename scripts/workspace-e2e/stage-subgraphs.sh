...
GENERATED_DIR="$ROOT_DIR/validation/workspace_e2e/artifacts/generated"
STAGED_DIR="$RUNTIME_DIR/base/custom_nodes/workspace_e2e/subgraphs"
...
print(f"Staged {len(entries)} workspace subgraphs")
